              ...
              <div className="flex flex-col gap-1 bg-transparent">
                <button className="text-sm text-left hover:underline">
                  <div className="flex flex-row" onClick={() => navigate('/profile')}>
                    <MdOutlineAccountTree size={20} className="mr-4 text-amber-400" /> Accounts
                  </div>
                </button>
                <button className="text-sm text-left hover:underline">
                  <div className="flex flex-row">
                    <RiAccountCircleFill size={20} className="mr-4 text-amber-400" /> Profile
                  </div>
                </button>
                <button className="text-sm text-left hover:underline">
                  <div className="flex flex-row">
                    <CiSettings size={20} className="mr-4 text-amber-400" /> Settings
                  </div>
                </button>
