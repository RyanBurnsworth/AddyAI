...
export const GOOGLE_ADS_DELETED_EMAIL = ({
  name,
}: {
  name: string;
}) => `
    ...
    <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Google Ads Deleted in AddyAI</title>
    </head>
    <body
        style="margin: 0; padding: 0; font-family: 'Segoe UI', Arial, sans-serif; background-color: #f5f6f8; color: #333;"
    >
        ...
        <tr>
            ...
            <p style="font-size: 16px; line-height: 1.6;">
                Hi ${name || "there"},
                <br /><br />
                Your Google Ads data has been successfully deleted from AddyAI as per your request.
                <br /><br />
                If you have any questions or need further assistance, feel free to reach out to us at <a href='info@addyai.net'>info@addyai.net</a>.
            </p>
